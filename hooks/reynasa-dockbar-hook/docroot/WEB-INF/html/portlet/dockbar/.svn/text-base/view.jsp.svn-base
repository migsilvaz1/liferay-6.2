...
if ( typeof jQuery == "undefined" ){
	 document.write('<script src="http://code.jquery.com/jquery-1.4.2.min.js"><\/script>');
...
%>
<script>
$('#_145_navAccountControls').mouseenter(function(){
    clearTimeout($(this).data('timeoutId'));
}).mouseleave(function(){
	 	
	var someElement = $(this),
		timeoutId = setTimeout(function(){
			someElement.children().removeClass("open");
    }, 4000); 
