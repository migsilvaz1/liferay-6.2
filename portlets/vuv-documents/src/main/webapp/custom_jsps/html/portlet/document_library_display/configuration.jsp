...
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -->		
		...
		%>
		<liferay-ui:panel collapsible="<%= true %>" extended="<%= true %>" persistState="<%= true %>" title="General">
			<%//TODO poner select para elegir estandar o carpeta del ciudadano%>
			<aui:input id="carpeta-ciudadano-type" label="Carpeta del ciudadano" name="preferences--carpetaDelCiudadano--" type="checkbox" value="<%=carpetaCiudadano%>" />
		</liferay-ui:panel>
<!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -->		
