 ...
 * @generated
 */
public class RNotificationServiceClp implements RNotificationService {
	public RNotificationServiceClp(InvokableService invokableService) {
		...
		_methodName3 = "addNewNotification";
	...
	public java.lang.String[] addNewNotification(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName3,
					...
					new Object[] {
						ClpSerializer.translateInput(codigoRemitente),
						
					ClpSerializer.translateInput(codigoDestinatarioList),
						
					ClpSerializer.translateInput(fechaPrevista),
						
					ClpSerializer.translateInput(titulo),
						
					ClpSerializer.translateInput(contenido),
						
					ClpSerializer.translateInput(motivo)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
