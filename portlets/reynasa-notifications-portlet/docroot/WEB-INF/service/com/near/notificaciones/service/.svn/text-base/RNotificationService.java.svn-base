...
/**
 * Provides the remote service interface for RNotification. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author nearTechnologies
 * @see RNotificationServiceUtil
...
public interface RNotificationService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RNotificationServiceUtil} to access the r notification remote service. Add custom service methods to {@link com.near.notificaciones.service.impl.RNotificationServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
