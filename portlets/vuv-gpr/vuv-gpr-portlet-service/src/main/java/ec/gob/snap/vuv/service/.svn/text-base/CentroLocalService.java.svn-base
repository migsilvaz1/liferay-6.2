...
/**
 * Provides the local service interface for Centro. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CentroLocalServiceUtil
...
public interface CentroLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link CentroLocalServiceUtil} to access the centro local service. Add custom service methods to {@link ec.gob.snap.vuv.service.impl.CentroLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
