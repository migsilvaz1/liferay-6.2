 ...
 * @generated
 */
public class Act_InstitucionalLocalServiceClp
    ...
    public Act_InstitucionalLocalServiceClp(
        ...
        _methodName19 = "addAct_Institucional";

        _methodParameterTypes19 = new String[] { "long", "long", "java.util.Date" };

        _methodName20 = "addAct_Institucional";

        _methodParameterTypes20 = new String[] {
                "long", "long", "java.util.Date", "long"
            };

        _methodName21 = "getAllAct_Institucionales";

        _methodParameterTypes21 = new String[] {  };

        _methodName22 = "getAct_InstitucionalBygprId";
    ...
    public ec.gob.snap.vuv.model.Act_Institucional addAct_Institucional(
        ...
        return (ec.gob.snap.vuv.model.Act_Institucional) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public ec.gob.snap.vuv.model.Act_Institucional createAct_Institucional(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { id_act_institucional });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
