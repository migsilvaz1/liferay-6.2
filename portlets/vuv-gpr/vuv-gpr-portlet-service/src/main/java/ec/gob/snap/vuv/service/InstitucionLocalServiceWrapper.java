...
public class InstitucionLocalServiceWrapper implements InstitucionLocalService,
    ...
    */
    ...
    public ec.gob.snap.vuv.model.Institucion createInstitucion(
        long id_institucion) {
        return _institucionLocalService.createInstitucion(id_institucion);
    }
    ...
    */
    ...
    public ec.gob.snap.vuv.model.Institucion deleteInstitucion(
        ...
        return _institucionLocalService.deleteInstitucion(id_institucion);
    }
    ...
    */
    ...
    public ec.gob.snap.vuv.model.Institucion fetchInstitucion(
        long id_institucion)
        throws com.liferay.portal.kernel.exception.SystemException {
        return _institucionLocalService.fetchInstitucion(id_institucion);
    }
    ...
    */
    ...
    public ec.gob.snap.vuv.model.Institucion getInstitucion(long id_institucion)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return _institucionLocalService.getInstitucion(id_institucion);
    }
    ...
    */
    ...
    public ec.gob.snap.vuv.model.Institucion addInstitucion(long gprId,
        ...
        return _institucionLocalService.addInstitucion(gprId, content, timeStamp);
    }

    @Override
    public java.util.List<ec.gob.snap.vuv.model.Institucion> getAllInstituciones() {
        return _institucionLocalService.getAllInstituciones();
    }

    @Override
    public java.util.List<ec.gob.snap.vuv.model.Servicio> getAllServiciosByIdInstitucion(
        long institucionId) {
        return _institucionLocalService.getAllServiciosByIdInstitucion(institucionId);
    }

    @Override
    public ec.gob.snap.vuv.model.Institucion getInstitucionBygprId(long gprId) {
        return _institucionLocalService.getInstitucionBygprId(gprId);
    }
