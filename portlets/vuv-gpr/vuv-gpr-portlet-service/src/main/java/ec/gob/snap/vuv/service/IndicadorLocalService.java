...
/**
 * Provides the local service interface for Indicador. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see IndicadorLocalServiceUtil
...
public interface IndicadorLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link IndicadorLocalServiceUtil} to access the indicador local service. Add custom service methods to {@link ec.gob.snap.vuv.service.impl.IndicadorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
