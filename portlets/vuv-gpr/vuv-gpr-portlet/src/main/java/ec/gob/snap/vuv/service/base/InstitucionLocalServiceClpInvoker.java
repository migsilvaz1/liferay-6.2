...
public class InstitucionLocalServiceClpInvoker {
    ...
    public InstitucionLocalServiceClpInvoker() {
        ...
        _methodParameterTypes0 = new String[] {
                "ec.gob.snap.vuv.model.Institucion"
            };
        ...
        _methodName66 = "addInstitucion";

        _methodParameterTypes66 = new String[] { "long", "long", "java.util.Date" };

        _methodName67 = "deleteInstitucion";

        _methodParameterTypes67 = new String[] { "long" };

        _methodName68 = "updateInstitucion";

        _methodParameterTypes68 = new String[] {
                "ec.gob.snap.vuv.model.Institucion"
            };

        _methodName69 = "getAllInstituciones";

        _methodParameterTypes69 = new String[] {  };

        _methodName70 = "getAllServiciosByIdInstitucion";

        _methodParameterTypes70 = new String[] { "long" };

        _methodName71 = "getInstitucionBygprId";
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName0.equals(name) &&
            ...
            return InstitucionLocalServiceUtil.addInstitucion((ec.gob.snap.vuv.model.Institucion) arguments[0]);
        }
        ...
        if (_methodName3.equals(name) &&
            ...
            return InstitucionLocalServiceUtil.deleteInstitucion((ec.gob.snap.vuv.model.Institucion) arguments[0]);
        }
        ...
        if (_methodName15.equals(name) &&
            ...
            return InstitucionLocalServiceUtil.updateInstitucion((ec.gob.snap.vuv.model.Institucion) arguments[0]);
        }
        ...
        if (_methodName66.equals(name) &&
            ...
            return InstitucionLocalServiceUtil.addInstitucion(((Long) arguments[0]).longValue(),
        ...
        if (_methodName69.equals(name) &&
            ...
            return InstitucionLocalServiceUtil.getAllInstituciones();
        }

        if (_methodName70.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes70, parameterTypes)) {
            return InstitucionLocalServiceUtil.getAllServiciosByIdInstitucion(((Long) arguments[0]).longValue());
        }

        if (_methodName71.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes71, parameterTypes)) {
            return InstitucionLocalServiceUtil.getInstitucionBygprId(((Long) arguments[0]).longValue());
        }
