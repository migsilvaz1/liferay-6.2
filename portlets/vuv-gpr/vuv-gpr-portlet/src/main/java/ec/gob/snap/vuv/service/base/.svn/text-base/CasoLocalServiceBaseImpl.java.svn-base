...
import ec.gob.snap.vuv.service.CasoLocalService;
...
/**
 * Provides the base implementation for the caso local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ec.gob.snap.vuv.service.impl.CasoLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class CasoLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements CasoLocalService, IdentifiableBean {
    ...
    private CasoLocalServiceClpInvoker _clpInvoker = new CasoLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link ec.gob.snap.vuv.service.CasoLocalServiceUtil} to access the caso local service.
     */
    ...
    @Override
    public Caso addCaso(Caso caso) throws SystemException {
        caso.setNew(true);

        return casoPersistence.update(caso);
    }
     ...
     */
    @Override
    public Caso createCaso(long id_caso) {
        return casoPersistence.create(id_caso);
    }
    ...
    @Override
    public Caso deleteCaso(long id_caso)
        throws PortalException, SystemException {
        return casoPersistence.remove(id_caso);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Caso deleteCaso(Caso caso) throws SystemException {
        return casoPersistence.remove(caso);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Caso.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return casoPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
        throws SystemException {
        return casoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return casoPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery,
        ...
        return casoPersistence.countWithDynamicQuery(dynamicQuery, projection);
    }

    @Override
    public Caso fetchCaso(long id_caso) throws SystemException {
        return casoPersistence.fetchByPrimaryKey(id_caso);
    }
     ...
     */
    @Override
    public Caso getCaso(long id_caso) throws PortalException, SystemException {
        return casoPersistence.findByPrimaryKey(id_caso);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return casoPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<Caso> getCasos(int start, int end) throws SystemException {
        return casoPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getCasosCount() throws SystemException {
        return casoPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Caso updateCaso(Caso caso) throws SystemException {
        return casoPersistence.update(caso);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("ec.gob.snap.vuv.model.Caso",
            casoLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "ec.gob.snap.vuv.model.Caso");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = casoPersistence.getDataSource();
