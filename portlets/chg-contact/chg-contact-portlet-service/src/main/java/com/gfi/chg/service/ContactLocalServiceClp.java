...
public class ContactLocalServiceClp implements ContactLocalService {
    ...
    public ContactLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "findByContactId";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "findByCreateDate";
    ...
    public com.gfi.chg.model.Contact addContact(
        ...
        return (com.gfi.chg.model.Contact) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.gfi.chg.model.Contact> getContacts(int start,
        ...
        return (java.util.List<com.gfi.chg.model.Contact>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.gfi.chg.model.Contact> findByAreaId(long areaId)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName24,
                    _methodParameterTypes24, new Object[] { areaId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
