...
/**
 * Provides the local service interface for Tracing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TracingLocalServiceUtil
...
public interface TracingLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TracingLocalServiceUtil} to access the tracing local service. Add custom service methods to {@link com.gfi.chg.service.impl.TracingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
