...
public class AreaLocalServiceClp implements AreaLocalService {
    ...
    public com.gfi.chg.model.Area addArea(com.gfi.chg.model.Area area)
        ...
        return (com.gfi.chg.model.Area) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<com.gfi.chg.model.Area> getAreas(int start, int end)
        ...
        return (java.util.List<com.gfi.chg.model.Area>) ClpSerializer.translateOutput(returnObj);
    }
