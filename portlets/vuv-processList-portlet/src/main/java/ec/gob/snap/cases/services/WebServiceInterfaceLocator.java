...
public class WebServiceInterfaceLocator extends org.apache.axis.client.Service implements ec.gob.snap.cases.services.WebServiceInterface {
    ...
    private java.lang.String WebServiceInterfacePort_address = "http://192.168.8.75:8181/cxf/cases-user-bpm";
    ...
    public ec.gob.snap.cases.services.WebServiceInterfacePortType getWebServiceInterfacePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ec.gob.snap.cases.services.WebServiceInterfaceSoapBindingStub _stub = new ec.gob.snap.cases.services.WebServiceInterfaceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ec.gob.snap.cases.services.WebServiceInterfacePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ec.gob.snap.cases.services.WebServiceInterfaceSoapBindingStub _stub = new ec.gob.snap.cases.services.WebServiceInterfaceSoapBindingStub(new java.net.URL(WebServiceInterfacePort_address), this);
                _stub.setPortName(getWebServiceInterfacePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.cases.snap.gob.ec/", "WebServiceInterface");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.cases.snap.gob.ec/", "WebServiceInterfacePort"));
        }
